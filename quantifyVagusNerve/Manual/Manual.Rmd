...
The nerve cross-sections are scaled with the largest range along the y-axis.
...
There is another code file in the directory named *BarycenterSpatialIntensity_2.R* that helps in running the codes with input files in batches.
