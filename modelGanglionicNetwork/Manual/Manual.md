...
Afterwards, we analyze the ENS ganglia and ganglionic neurons as point
patterns and the ENS network as linear network or graph objects. We use
R libraries *spatstat* and *igraph* for this purpose, along with other
necessary libraries. In our experiments we used *Fiji v1.53h* and *R
version 4.0.2* in RStudio.
