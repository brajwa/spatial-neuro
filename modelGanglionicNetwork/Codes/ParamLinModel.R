...
face_feature_spn = read.csv("C:/Users/sanja/Documents/GitHub/spatial-neuro/modelGanglionicNetwork/Outputs/ENSMouse/FaceFeature/Facefeatures_2.csv")
...
transformed_spn_feature = asinh(face_feature_spn[, spn_feature_index])
